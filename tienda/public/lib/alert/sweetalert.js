...
!(function (t, e) {
  ...
  function ln() {
    ...
    e
      ? (t.popup && g.swalCloseEventFinishedCallback && (g.swalCloseEventFinishedCallback(), delete g.swalCloseEventFinishedCallback), "function" == typeof e.didDestroy && e.didDestroy(), dn(this))
      : fn(this);
  }
  var dn = function (t) {
  ...
  var Bn,
    ...
    Hn = function (t) {
      ...
      return (
        n && (_n(n, ["type", "color"]), n.hasAttribute("type") && (e.icon = n.getAttribute("type")), n.hasAttribute("color") && (e.iconColor = n.getAttribute("color")), (e.iconHtml = n.innerHTML)), e
      );
    },
    Dn = function (t) {
      var e = {},
